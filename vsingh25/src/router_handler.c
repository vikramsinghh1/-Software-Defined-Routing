...
#include <unistd.h>
#include <string.h>
#include <arpa/inet.h>  // too many headers, remove unnecessary if time

// right now there are two functions..cost =0 is the server(listening) router and the rest of them are clients(havent been binded as of now, will bind as per the requirement)
